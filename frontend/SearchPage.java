...
public class SearchPage extends javax.swing.JFrame {
    static String id;
    private String searchPeopleSubstring;
    private String searchGroupsSubstring;
    private ArrayList<String> oldExecutedQueryToAvoidResearchingForSamePeopleQuery = new ArrayList<>();
    private ArrayList<String> oldExecutedQueryToAvoidResearchingForSameGroupsQuery = new ArrayList<>();
    ...
    private void searchPeopleButtonActionPerformed(java.awt.event.ActionEvent evt) throws IOException {
        ...
        if (searchPeopleSubstring != null && searchPeopleSubstring.equalsIgnoreCase(query)) {
            UserSearchResultPanel userSearchResultPanel = new UserSearchResultPanel(id, oldExecutedQueryToAvoidResearchingForSamePeopleQuery);
...
/*
        if (searchGroupsSubstring != null && searchGroupsSubstring.equalsIgnoreCase(query)) {
            GroupSearchResultPanel groupSearchResultPanel = new GroupSearchResultPanel(id, oldExecutedQueryToAvoidResearchingForSameGroupsQuery);
            updateScrollPane(groupSearchResultPanel);
            return;
        }

        searchGroupsSubstring = query;
        ArrayList<String> groupIds = SearchManager.getInstance().searchGroupQuery(id, searchGroupsSubstring);
        oldExecutedQueryToAvoidResearchingForSameGroupsQuery = groupIds;
