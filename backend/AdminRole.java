...
public class AdminRole extends MemberRole{
    ...
    void approveRequest(String UserId,String GroupId){
        // groupManager.approveRequest(UserId,GroupId);
    }
    void declineRequest(String UserId,String GroupId){
        // groupManager.declineRequest(UserId,GroupId);
    }
}
